...
{
    public partial class NivelBase : MetroForm
    {
        ...
        public NivelBase(List<Word> words)
        {
            InitializeComponent();
            if (words != null)
                Init(words);
        ...
        private void UpdateUI()
        {
            ...
            //metroLabelPalabra.Text = ExpectedWord.WordName;
        }
        ...
        private void Correct2Dialog(Word Word)
        {
            ...
            switch (dialog)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    TTS.Speak("Perfecto, dijiste la palabra " + Word.WordPhonetic);
                    break;
            }
        }
