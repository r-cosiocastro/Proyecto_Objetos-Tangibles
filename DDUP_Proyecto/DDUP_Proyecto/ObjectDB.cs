...
namespace DDUP_Proyecto
{
    public class ObjectDB : SqliteHelper
    {
        ...
        {
            Console.WriteLine(Tag + "Getting Object: " + str);
        ...
        public IDataReader getDataByType(string str)
        {
            Console.WriteLine(Tag + "Getting Object: " + str);
        ...
        {
            Console.WriteLine(Tag + "Deleting Object: " + id);
        ...
        {
            Console.WriteLine(Tag + "Deleting Table");
